  ...
  return (
    <div className='divDisplay'>
        ...
        <form className="regForm">
            ...
            <input type="number" id="principal" name="principal" value={principal} onChange={handleInputChange} /><br />
            <label>Rate of Interest</label>
            <input type="number" id="interest" name="interest" value={interest} onChange={handleInputChange} />
            <br />
            <label>Duration (In months)</label>
            <input type="number" id="duration" name="duration" value={duration} onChange={handleInputChange} />
            <br />
            <button type="button" onClick={generateEmiTable}>Submit</button>
        </form>
      <br />
      {emiTable.length > 0 && (
